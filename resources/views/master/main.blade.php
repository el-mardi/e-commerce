...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="my-2">
      ...
      <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-secondary shadow ">
          <ul class="navbar-nav ">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item " style="margin-left: 30%">
                <a class="nav-link" href="{{route('user.create')}}"><i class="fas fa-user fa-lg"></i></a>
              </li>

              <li class="nav-item">
                <a class="nav-link" href="/login"><i class="fas fa-user-circle  fa-lg"></i></a>
              </li>
              <li class="nav-item">
      ...
      <br>
       ...
       <nav class="navbar navbar-expand-lg navbar-light bg-light mt-5 mb-2">
