...
<h4 style="display: inline">Pictures management</h4>
...
<div class="row mt-3">
    ...
    <a href="" class="col-sm-3 btn btn-success " style="position:absolute; right: 30px;"> Add new picture <i class="fas fa-plus-square"></i> </a>
</div>     
